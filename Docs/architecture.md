...
The shipped app is observer-only: it captures screen context, extracts text/barcodes/UI geometry locally, and answers questions. It does not click, type, open apps, navigate browsers, run shell commands, use MCP integrations, or mutate Calendar/Reminders/Finder/Music state.
