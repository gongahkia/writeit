...
- [ ] [P1][release] Add a release smoke script that runs build, package, Gatekeeper, demo, and OSS checks with one command.
...
- [ ] [P0][oss] Run `Scripts/open_source_check.sh secrets` before visibility change.
- [ ] [P0][oss] Run `Scripts/open_source_check.sh artifacts` before visibility change.
- [ ] [P0][oss] Run `Scripts/open_source_check.sh worktree` before visibility change.
...
- [ ] [P1][adapter] Add dataset statistics output for task categories, tools, and response lengths.
...
- [ ] [P1][docs] Add a troubleshooting section for MCP OAuth failures.
- [ ] [P1][docs] Add a troubleshooting section for shell XPC connection failures.
- [ ] [P1][docs] Add examples for safe natural-language requests.
- [ ] [P1][docs] Add examples for requests that require confirmation.
- [ ] [P1][docs] Add examples for refused unsafe requests.
